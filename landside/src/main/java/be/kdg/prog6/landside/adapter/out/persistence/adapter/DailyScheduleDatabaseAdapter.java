package be.kdg.prog6.landside.adapter.out.persistence.adapter;

import be.kdg.prog6.landside.adapter.out.persistence.entity.AppointmentJpaEntity;
import be.kdg.prog6.landside.adapter.out.persistence.entity.DailyScheduleJpaEntity;
import be.kdg.prog6.landside.adapter.out.persistence.entity.TimeSlotJpaEntity;
import be.kdg.prog6.landside.adapter.out.persistence.repository.AppointmentJpaRepository;
import be.kdg.prog6.landside.adapter.out.persistence.repository.DailyScheduleJpaRepository;
