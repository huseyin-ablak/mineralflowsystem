package be.kdg.prog6.invoicing.adapter.out.persistence.adapter;

import be.kdg.prog6.invoicing.adapter.out.persistence.entity.InvoiceJpaEntity;
import be.kdg.prog6.invoicing.adapter.out.persistence.entity.InvoiceLineJpaEntity;
import be.kdg.prog6.invoicing.adapter.out.persistence.repository.InvoiceJpaRepository;
import be.kdg.prog6.invoicing.adapter.out.persistence.value.MonetaryValueEmbeddable;
