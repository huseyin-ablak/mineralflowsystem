package be.kdg.prog6.warehousing.adapter.out.persistence.adapter;

import be.kdg.prog6.warehousing.adapter.out.persistence.entity.OrderLineJpaEntity;
import be.kdg.prog6.warehousing.adapter.out.persistence.entity.PurchaseOrderJpaEntity;
import be.kdg.prog6.warehousing.adapter.out.persistence.repository.PurchaseOrderJpaRepository;
