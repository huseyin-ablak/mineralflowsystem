package be.kdg.prog6.waterside.adapter.out.persistence.adapter;

import be.kdg.prog6.waterside.adapter.out.persistence.entity.BunkeringOperationJpaEntity;
import be.kdg.prog6.waterside.adapter.out.persistence.entity.InspectionOperationJpaEntity;
import be.kdg.prog6.waterside.adapter.out.persistence.entity.ShippingOrderJpaEntity;
import be.kdg.prog6.waterside.adapter.out.persistence.repository.ShippingOrderJpaRepository;
